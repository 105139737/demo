...
<script type="text/javascript" src="jquery.ui.datepicker.min.js"></script>
 ...
 <body >
                ...
                <section class="content-header">
                 ...
                 Product Point
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Product Point</li>
                    </ol>
                </section>
 	...
 	<form name="f" method="post" action="points.php">
     <center>
 ...
 <table border="0"  class="table table-hover table-striped table-bordered" >
		     ...
		     <tr>
            <td  align="right" style="padding-top:17px"><b>Product :</b></td>
            <td  align="left">
...
$brand=$row1['brand'];
            ...
            <td  align="left">
			<input type="text" class="form-control" id="point"  name="point" placeholder="Piece per Point... "  onkeypress="return check(event)"  required>
			</td>
...
<input type="submit" class="btn btn-primary" id="Button1" name="" value="Add" >
