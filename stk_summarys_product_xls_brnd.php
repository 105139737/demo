...
$query4="Select ((sum((main_stock.stin)*$rt))/sum(main_stock.stin)) as stck1 from main_stock where pcd='$pcd' and main_stock.stin>0 $todt  $brncd1 group by pcd";
$result4 = mysqli_query($conn,$query4);
while ($R4 = mysqli_fetch_array ($result4))
{
...
$query4="Select ((sum((main_stock.stout)*$rt))/sum(main_stock.stout)) as stck1 from main_stock where pcd='$pcd' and main_stock.stout>0 $todt  $brncd1 group by pcd";
$result4 = mysqli_query($conn,$query4);
while ($R4 = mysqli_fetch_array ($result4))
{
