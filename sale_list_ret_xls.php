...
$file="Sale Return Details (".$fdt." To ".$tdt.".xls";
...
$data1= mysqli_query($conn,"select * from  main_billing_ret where sl>0".$invdt1.$todts.$snm1.$brncd1.$gst_no1.$tp11.$sale_per1." order by dt,sl")or die(mysqli_error($conn));
...
$pnm=$row['pnm'];
	...
	if($blno==$blno1)
	{
		...
		<td  align="left" ><b><?php  echo $invdt;?></b></td>
