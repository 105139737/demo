...
$query1 = "SELECT * FROM main_old_ptemp where prsl='$prnm' and eby='$user_currently_loged' $ssl";
...
if($tsl=="")
{
$query21 = "INSERT INTO main_old_ptemp(cat,scat,unit,prsl,qty,mrp,ttl,eby,fst,tst,cgst_rt,sgst_rt,igst_rt,cgst_am,sgst_am,igst_am,net_am,amm,usl,total,disp,disa,ldis,ldisa,bcd,rate,betno)
...
{
$query21 = "UPDATE main_old_ptemp SET cat='$cat',scat='$scat',unit='$unit',prsl='$prnm',qty='$qnty',mrp='$mrp',
