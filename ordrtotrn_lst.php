...
$car1=0;	
$vatamm1=0;
$data1= mysqli_query($conn,"select * from  main_gordr where sl>0".$todts.$brncd1)or die(mysqli_error($conn));
...
$tbcd=$row1['tbcd'];	
$bnm222="";
$data22= mysqli_query($conn,"select * from main_branch where sl='$tbcd'")or die(mysqli_error($conn));
while ($row12t = mysqli_fetch_array($data22))
{
$bnm222=$row12t['bnm'];
}
...
$data= mysqli_query($conn,"select * from  main_gordrdtl where sl>0 and blno='$blno'".$pnm1)or die(mysqli_error($conn));
