...
function get_list()
{
	...
	$('#div_list').load('billtyp_select_return.php?all='+encodeURIComponent(all)+'&tp1='+tp1+'&brand1='+brand1+'&brncd1='+brncd1).fadeIn('fast');
}
function submit(sl)
{
                ...
                <section class="content-header">
                   ...
                   Bill Type Return
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"> Bill Type Return</li>
                    </ol>
                </section>
...
<form method="post" action="sale_retn.php" id="form1" name="form1" target="_BLANK">      
