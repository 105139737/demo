...
if($err=="")
{
$query2 = "INSERT INTO ".$DBprefix."product (cat,scat,pnm,smvlu,mdvlu,bgvlu,hsn,mrp,ean) 
VALUES ('$cat','$scat','$pnm','$sret','$mret','$bret','$hsn','$ret','$ean')";
...
alert('Model Entry Completed. Thank You.....');
