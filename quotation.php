...
lttl=(total1-disa1).round(2);
	...
	function add()
	{
		...
		{
		$('#wb_Text13').load('quo_adtmppr.php?prnm='+prnm+'&desc='+encodeURIComponent(desc)+'&pcs='+pcs+'&prc='+prc+'&total='+total+'&disp='+disp+'&disa='+disa+'&lttl='+lttl+'&brncd='+brncd+'&fst='+fst+'&tst='+tst+'&cgst_rt='+cgst_rt+'&sgst_rt='+sgst_rt+'&igst_rt='+igst_rt+'&cgst_am='+cgst_am+'&sgst_am='+sgst_am+'&igst_am='+igst_am).fadeIn('fast');
		}
...
function temp()
	{
$('#wb_Text13').load("quo_tmppr.php").fadeIn('fast');
/*$('#fst_div').load("fst_get1.php").fadeIn('fast');
$('#tst_div').load("tst_get1.php").fadeIn('fast');*/
}
function deltpr(sl)
{
$('#wb_Text13').load("quo_deltpr.php?sl="+sl).fadeIn('fast');
}
function tot()
	{
	$('#billamm').load('quo_stotal.php').fadeIn('fast');
	$('#gst_am').load('quo_gst_am.php').fadeIn('fast');
	}
...
<form method="post" target="" name="form1" id="form1"  action="quotations.php">
...
<td colspan="">
<input type="text" id="cust_nm" class="form-control" style="font-weight: bold;" name="cust_nm" value="" tabindex="1" placeholder="Please Enter Customer Name" required>
</td>
<td align="right" style="padding-top:15px;"><b>Contact No. :</b></td>
<td colspan="">
<input type="text" id="cont" class="form-control" style="font-weight: bold;" name="cont" value="" tabindex="1" placeholder="Please Enter Contact No." onkeypress="return isNumber(event)" maxlength="10">
</td>
</tr>
...
<td colspan="">
<input type="text" id="gstin" class="form-control" style="font-weight: bold;" name="gstin" value="" tabindex="1" placeholder="Please Enter GSTIN No.">
</td>

<td align="right" style="padding-top:15px;"><b><font color="red">*</font>Address :</b></td>
<td colspan="">
<input type="text" id="adrs" class="form-control" style="font-weight: bold;" name="adrs" value="" tabindex="1" placeholder="Please Enter Address" required>
</td>
...
<input type="button" class="btn btn-success btn-sm" id="Button2" onclick="check()" name="bt1" tabindex="1" value="Submit" style="width:10%;" >
</td>
</tr>
</table>
</div>
