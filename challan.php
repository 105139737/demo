...
//$("#runt").append('<option value="'+unts+'">'+unts+'</option>'); 
	...
	function add()
	{
		...
		$('#wb_Text13').load("adtmppr_challan.php?pid="+pid+"&qty="+qty+"&unt="+unt+"&prc="+prc+"&runt="+runt+"&betno="+betno+"&expdt="+expdt+"&prnm="+prnm+"&lttl="+lttl+"&usl="+usl).fadeIn('fast');
  ...
  $('#prnm').trigger('chosen:open');
			...
			function temp()
	{
		...
		$('#wb_Text13').load("tmppr_challan.php").fadeIn('fast');
			
	}
		function deltpr(sl)
	{
	
	$('#wb_Text13').load("deltpr_challan.php?sl="+sl).fadeIn('fast');
	...
	function t()
{
	...
	$('#pay').load('stotal_challan.php').fadeIn('fast');
	...
	function ddet()
	{
		cno=document.getElementById('cno').value;
		    $.get('car.php?cno='+cno, function(data) {
        
        
    $('#cdet').val(data);
document.getElementById('cdet').focus();


});
		$('#dirver').load("dirver.php?cno="+cno).fadeIn('fast');
	...
	{
		cno=document.getElementById('cno').value;
		dnm=document.getElementById('dnm').value;
		    $.get('cardir.php?cno='+cno+'&dnm='+dnm, function(data) {
           var str= data;
				var stra = str.split("@")
                ...
                <section class="content-header">
                 ...
                 Road Challan
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Road Challan</li>
                    </ol>
                </section>
...
<form method="post" target="" name="form1" id="form1"  action="challans.php" onsubmit="return check1()">
...
<td>
<input type="text" id="qnty" class="sc" autocomplete="off"  name="qnty" value="" onkeyup="lttla('','')"  size="15" >
 </td>
<td>
<div class="un">
...
<td>
<div id="p">
<input type="text" class="sc" autocomplete="off" id="prc" name="prc" value="" onkeyup="lttla('','')" size="15"  >
</div>
</td>
...
<td>
<input type="button" class="btn btn-primary" id="Button1" name="" value="Add"  onclick="add()"  style="width:100px;padding:3px" >
</td>
</tr>
</table>
   </td>
...
<td align="left" >
<input type="hidden" name="car" id="car"   onblur="v()" value="" class="sc"  style="text-align:right">
</td>
...
<td align="left" >
<input type="hidden" name="vat" id="vat" onblur="v()" class="sc"  style="text-align:right" >
...
<td align="left" >
<input type="hidden" name="vatamm" id="vatamm" class="sc" style="background-color:#f3f4f5;text-align:right" readonly="true" >
...
<b>
<div id="pay">
<input type="text" name="tamm" id="tamm" class="sc" style="background-color:#f3f4f5;width:300px;"  readonly="true"> 
</div>
</b>
</font>
</td>
...
<input type="submit" class="btn btn-success" id="Button2" name="" value="Submit" >
  ...
  <table border="0" width="860px" class="table table-hover table-striped table-bordered" style="display:none;">
