...
function get_list()
{
	...
	$('#div_list').load('billtyp_select.php?all='+encodeURIComponent(all)+'&tp1='+tp1+'&brand1='+brand1+'&brncd1='+brncd1).fadeIn('fast');
}
                ...
                <section class="content-header">
                   ...
                   Bill Type(Duplicate)
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"> Bill Type(Duplicate)</li>
                    </ol>
                </section>
...
<form method="post" action="billing_gst_dup.php" id="form1" name="form1" target="_BLANK">      
