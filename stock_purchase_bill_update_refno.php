...
$expdt=$row['expdt'];
$bccnt++;
 $query8=mysqli_query($conn,"Select * from ".$DBprefix."stock where pcd='$pcd' and stin='$qty' and betno='$betno' and expdt='$expdt'  and nrtn='Purchase' and refno='$blno'")or die(mysqli_error($conn));
