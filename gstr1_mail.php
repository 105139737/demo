...
$from = "gstapp@onnetsolution.com"; 
$subject = "GST-Report 1 From Date : ".$fdt." To Date : ".$tdt; 
...
$mail=new PHPMailer(true);
	...
	try 
	{
		$mail->Host				=	"mail.mybilling.software";				//	SMTP server
		$mail->SMTPDebug		=	0;								//	Enables SMTP debug information (for testing)
		$mail->SMTPAuth			=	true;							//	Enable SMTP authentication
		$mail->Port				=	26;							//	Set the SMTP port for the GMAIL server
		$mail->Username			=	"no-reply@mybilling.software";			//	SMTP account user-name
		$mail->Password			=	"99@erGt45Ac";					//	SMTP account password
		$mail->AddAddress($to);
		...
		$mail->addAttachment($filename,'GSTR_1_Report.xls');
		$mail->Send();
