...
<tr >
<td align="right" style="width: 50%;border-bottom: 1px solid #000;border-top: 1px solid #000;">
<font size="3" color="red">Total Bal : <?php echo sprintf('%0.2f', $ctotal);?></font>
</td>
<td align="right" color="red" style="width: 50%;border-bottom: 1px solid #000;border-top: 1px solid #000;">
