...
$('#sgh').load('sale_per_lists.php?all='+encodeURIComponent(all)+'&brncd='+brncd).fadeIn('fast');
}
...
$('#sgh').load("sale_per_lists.php?ps="+ps+"&pno="+pno+"&all="+encodeURIComponent(src)+'&brncd='+brncd).fadeIn('fast');
$('#pgn').val=pno;
}
...
<!-- Right side column. Contains the navbar and content of the page -->
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1 align="center">Sale Person List</h1>
                    <ol class="breadcrumb">
                       <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li class="active"> Sale Person List</li>
                    </ol>
                </section>
                <!-- Main content -->
