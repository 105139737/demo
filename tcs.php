...
$('#data8').load('tcss.php?fdt='+fdt+'&tdt='+tdt+'&brncd='+brncd).fadeIn('fast');
}
            ...
            <aside class="right-side">
               ...
               TCS
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">TCS</li>
                    </ol>
                </section>

                <!-- Main content -->
<section class="content">			
<form method="post" action="tcss.php" name="form1"  id="form1">
    <input type="hidden" id="typ" name="typ" size="13" value="1"  > 
...
<td align="left" width="20%" ><b>Branch:</b><br>
