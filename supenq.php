...
<span style="color:#000000;font-family:Arial;font-size:19px;"><strong><u><?php  echo $snm;?></u></strong></span></div>

<div id="wb_Text2" style="position:absolute;left:20px;top:115px;width:320px;height:18px;z-index:1;text-align:left;">

<span style="color:#000000;font-family:Arial;font-size:16px;">Prop : <?php  echo $nm;?></span></div>

<div id="wb_Text3" style="position:absolute;left:20px;top:145px;width:320px;height:88px;z-index:2;text-align:left;">

<span style="color:#000000;font-family:Arial;font-size:16px;">Address: <?php  echo $adr;?> <br><br><br><br></span></div>
...
<img src="barcode.php?text=<?php  echo $a;?>" id="Image2" alt="" border="0" style="width:220px;height:32px;"></div>

<div id="wb_Text4" style="position:absolute;left:355px;top:145px;width:320px;height:18px;text-align:right;z-index:5;">

<span style="color:#000000;font-family:Arial;font-size:16px;">Customer Code : <?php  echo $a;?></span></div>

<div id="wb_Text5" style="position:absolute;left:355px;top:175px;width:320px;height:18px;text-align:right;z-index:6;">

<span style="color:#000000;font-family:Arial;font-size:16px;">Customer Type : <?php  echo $cstp;?></span></div>
...
<span style="color:#000000;font-family:Arial;font-size:18px;"><ins>Statement for the period (From : <?php  echo date('d-m-Y', strtotime($fdt)); ?>&nbsp; To : <?php  echo date('d-m-Y', strtotime($tdt)); ?>)</ins></span></div>
...
<div><span style="color:#000000;font-family:Arial;font-size:13px;"> <?php  echo $opbl;?></span></div>
...
<div><span style="color:#000000;font-family:Arial;font-size:13px;"><?php  echo $rd;?></span></div>
