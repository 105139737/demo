	...
	function show1()
{
 ...
 $('#data8').load('day_point_list.php?fdt='+fdt+'&tdt='+tdt+'&custnm='+encodeURIComponent(custnm)+'&brncd='+brncd).fadeIn('fast');
            ...
            <aside class="right-side">
               ...
               Point (Day Wise)
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Point (Day Wise)</li>
                    </ol>
                </section>
 ...
 <td align="left"><b>Customer Name :</b><br>
  ...
  <select id="custnm" name="custnm"  class="form-control" onchange="gtid()" >
	...
	?>
		  ...
		  <td align="left" ><b>Customer SL :</b><br>
