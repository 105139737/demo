...
<td align="center" hidden><b><?php  echo $betno;?></b></td>
<td align="center" width="6%" ><b><?php  echo $qty;?></b></td>
<td align="right" width="6%" ><b><?php echo round($mrp,2);?></b></td>			
<td align="right" width="8%" ><b><?php  echo $total;?></b></td>
...
<td align="right" width="8%" ><b><?php echo round($ttl,2);?></b></td>
...
<td align="center" width="4%"><b><a onclick="if(confirm('Are you Sure?')){deltpr1('<?php  echo $tsl;?>')}"><font color="red">Delete</font></a> </b></td>
</tr>
<?php 
$total_am+=$total;
$total_cgst+=$cgst_am;
