...
$query7="Select * from main_ser_slt where prsl='$prnm' and eby='$user_currently_loged' $ssl";
...
if($tsl=="")
{
$query21 = "INSERT INTO main_ser_slt (total,disp,disa,cat,scat,prsl,unit,pcs,prc,ttl,eby,fst,tst,cgst_rt,sgst_rt,igst_rt,cgst_am,sgst_am,igst_am,net_am,refno,usl,bcd,betno,tamm,rate,bill_typ)
...
{
$query21 = "UPDATE main_ser_slt SET total='$total',disp='$disp',disa='$disa',cat='$cat',scat='$scat',prsl='$prnm',
