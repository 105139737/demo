...
$get=mysqli_query($conn,"select * from main_billtype where sl>0 and stat='0' and inv_typ='2' $all1 $tp2 $brand2 $brncd2 order by als") or die(mysqli_error($conn));
...
<th style="text-align:center;display:none;">Brand </th>
