...
function show1()
{
 ...
 //$('#data8').load('gstr_1s.php?fdt='+fdt+'&tdt='+tdt).fadeIn('fast');
document.location='gstr_1s.php?fdt='+fdt+'&tdt='+tdt;
}
	function xls()
{
 var fdt= document.getElementById('fdt').value;
...
<input type="button" class="btn btn-primary" value="Excel Export" onclick="show1()">
</td>
</tr>
</thead>
