...
<option selected value="2">Direct</option>
  ...
  <td> <input type="text" class="form-control" id="ddt"  name="ddt" value="<?php  echo $edt;?>" tabindex="1" size="35" placeholder="Enter Date"></td>
 ...
 <input type="text" id="custnm" class="form-control" name="custnm" value="<?php  echo $spn;?>" tabindex="3" size="60" placeholder="Please Enter Customer Name" >
 ...
 <input type="text" id="fid" class="form-control" name="fid" value="<?php  echo $fid;?>" tabindex="3" size="34" placeholder="Please Enter Fertilizer ID (optional)" >
...
<input type="text" id="mob" class="form-control" name="mob" value="<?php  echo $mob1;?>" tabindex="4" size="35" placeholder="Please Enter Customer Contact No">
...
<div id="adr">
 ...
 <input type="tex" class="form-control" id="addr" name="addr" value="<?php  echo $addr;?>" tabindex="4" size="156" placeholder="Please Enter Customer Address">
...
<input type="text" name="car" id="car"   onblur="v()" value="<?php  echo $car;?>" class="sc"  style="text-align:right">
...
<input type="text" name="vat" id="vat" onblur="v()" class="sc"  value="<?php  echo $vat;?>" style="text-align:right" >
