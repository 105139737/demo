...
?>
          ...
          <tr>
            ...
            <td><div id="<?php  echo $grdv;?>"><a onclick="showeditledg('<?php  echo $x;?>','gcd','<?php  echo $y;?>','<?php  echo $grdv;?>')"><?php  echo $m;?></a></div></td>

            <td><div id="<?php  echo $ldgdv;?>"><a onclick="showeditledg('<?php  echo $x;?>','nm','<?php  echo $z;?>','<?php  echo $ldgdv;?>')"><?php  echo $z;?></a></div></td>
