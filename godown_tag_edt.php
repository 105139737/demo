...
$fdt="01-04-".$fy;
$sl=$_REQUEST['sl'];
$data11= mysqli_query($conn,"SELECT * FROM main_godown_tag where sl='$sl'");
...
<form method="post" action="godown_tag_edts.php" id="form1"  name="form1" >
<center>

  <div class="col-md-12" >
              <div class="box box-success box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title"> Godown Tag Edit</h3>
...
?>
<option value="<?php  echo $sl;?>"<?php  if($sl==$bcd){echo 'selected';}?> ><?php  echo $gnm;?></option>
<?php 
}
?>
</select>
