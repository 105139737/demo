...
$query111 = "SELECT * FROM main_ser_billing where blno='$blno'";
...
<td rowspan="1" style="text-align:center; border: 1px solid black;" ><font size="2">Perticular</font></td>
...
$pnm1="";
$total_qty=0;
$data= mysqli_query($conn,"select * from  main_ser_billdtls where sl>0 and blno='$blno'")or die(mysqli_error($conn));
...
<td style="text-align:left;" ><font size="2"><?php  echo $pnm2;?></font></td>
