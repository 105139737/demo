...
if(fdt!=tdt && snm==""){
    alert("You have to excel export if you want to see data of more than 1 day")
}
else
{
...
function change_state(blno)
{
$('#cnt11').load('change_state.php?blno='+blno).fadeIn("fast");
...
<a class="btn btn-primary" target="_blank" href="stk_mod.php">Bill Merge</a>
