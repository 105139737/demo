...
$('#data8').load('sale_list_profit.php?fdt='+fdt+'&tdt='+tdt+'&snm='+encodeURIComponent(snm)+'&brncd='+brncd+'&prnm='+prnm+'&tp1='+tp1+'&gstin='+gstin+'&godown='+godown+'&stat='+stat+'&scat='+scat+'&cat='+cat+'&sale_per='+sale_per+'&delv='+delv+'&refsl='+refsl+'&ddt='+ddt).fadeIn('fast');
}
function view(blno)
{
var ddt= document.getElementById('ddt').value;
