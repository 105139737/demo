...
$expdt=$row['expdt'];
$bccnt++;
 $query8=mysqli_query($conn,"Select * from ".$DBprefix."stock where pcd='$pcd' and stout='$qty' and betno='$betno' and expdt='$expdt' and dt='$edt' and nrtn='Sale' and refno='$blno' and bcd='$bcd'")or die(mysqli_error($conn));
