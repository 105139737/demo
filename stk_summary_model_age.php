...
if(prnm!=''){
$('#sgh').load('stk_summarys_model_age.php?brncd='+brncd+'&scat='+scat+'&cat='+cat+'&rt='+rt+'&fdt='+fdt+'&tdt='+tdt+'&typ='+typ+'&prnm='+prnm).fadeIn('fast');
}
else
{
                ...
                <section class="content">
                    ...
                    <!-- Main row -->
                     ...
                     <!-- /.box (chat box) -->
                            ...
                            <!-- TO DO List -->
<form method="GET" action="stk_summarys_model_age.php" id="form1" name="form1">
...
<td  align="left" width="18%">
<b>Model :   &nbsp; <input type="box" id="prnm3" onkeyup="get_prod_by_name()" name="prnm3" placeholder="Min 3 Digit Model Name "></b><br>
<div id="prod_div">
