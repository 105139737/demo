...
$('#sgh').load('stk_summarys.php?brncd='+brncd+'&scat='+scat+'&cat='+cat+'&rt='+rt+'&fdt='+fdt+'&tdt='+tdt+'&rts='+rts).fadeIn('fast');
}
                ...
                <section class="content">
                    ...
                    <!-- Main row -->
                     ...
                     <!-- /.box (chat box) -->
                            ...
                            <!-- TO DO List -->
<form method="GET" action="stk_summarys.php" id="form1" name="form1">
...
<select name="rts" class="form-control" size="1" id="rts" tabindex="8">
