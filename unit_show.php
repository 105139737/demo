	   ...
	   $(document).ready(function()
{
 ...
 $('#sgh').load('unit_list.php?all='+encodeURIComponent(all)).fadeIn('fast');
...
function pagnt(pno){
    ...
    $('#sgh').load("unit_list.php?ps="+ps+"&pno="+pno+"&all="+encodeURIComponent(src)).fadeIn('fast');
	$('#pgn').val=pno;
    }
	function pagnt1(pno){
...
function edit(sl)
{
document.location='unit_edit.php?sl='+sl;
}
