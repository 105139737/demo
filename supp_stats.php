...
<table <?php if($val=='1'){?>width="70%"<?php  }else{?> width="100%" <?php } ?>  class="advancedtable" <?php if($val=='1'){?> border="1" <?php  } ?> >
<tr>

<td valign="top">
<table <?php if($val=='1'){?> border="1" <?php  } ?> width="100%" class="advancedtable">
<tr bgcolor="#e8ecf6">
...
<td align="right"><b></b><?php echo round($claim_amm,2);?></td>
...
<td align="right" width="10%"><font color="red" size="4"><b><?php echo round($Grandpay,2);?></b></font></td>
</tr>
<tr bgcolor="#ffff00">
