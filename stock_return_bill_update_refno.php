...
$rdt=$row['rdt'];
$bccnt++;
 $query8=mysqli_query($conn,"Select * from ".$DBprefix."stock where pcd='$pcd' and stin='$qty' and betno='$betno' and expdt='$expdt' and nrtn='Sale Return' and refno='$blno' and bcd='$bcd'")or die(mysqli_error($conn));
