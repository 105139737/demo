...
$query51="select * from ".$DBprefix."billing order by sl";
...
if($dis>0)
{
	$query21 = "INSERT INTO ".$DBprefix."drcr (vno,cbill,cid,dt,nrtn,dldgr,cldgr,amm,brncd,eby,edtm) VALUES ('$vcno','$blno','$custnm','$dt','Discount','29','4','$dis','$brncd','$user_currently_loged','$dttm')";
...
$query211 = "INSERT INTO ".$DBprefix."billing (blno,cid,amm,paid,crdtp,cbnm,dt,edt,pdts,vat,vatamm,car,dis,bcd,eby) VALUES ('$blno','$custnm','$gttl','$pamm','$mdt','$cbnm','$dt','$cdt','$dttm','$vat','$vatamm','$car','$dis','$brncd','$user_currently_loged')";
...
$rmk=$R100['rmk'];
$ret=$prc;
$query21 = "INSERT INTO ".$DBprefix."billdtls (prsl,prnm,qty,prc,ttl,blno,rmk,pslno) VALUES ('$prsl','$prnm','$qnty','$prc','$ttl','$blno','$rmk','$pslno')";
$result21 = mysqli_query($conn,$query21)or die (mysqli_error($conn)); 


$stout=$qnty;

$query21 = "INSERT INTO ".$DBprefix."stock (pcd,bcd,dt,stout,nrtn,eby,dtm,stat,ret,refno,sbill) VALUES ('$prsl','$brncd','$dt','$stout','Sale','$user_currently_loged','$dttm','1','$ret','$blno','$blno')";
$result21 = mysqli_query($conn,$query21)or die (mysqli_error($conn)); 
...
<font size="5"> <b><a href="ord_billing.php" ><u>Back</u></a></b></font>
</td>
<td  align="left">
<font size="5"> <b><a href="bill_new.php?blno=<?php echo rawurlencode($blno);?>" target="_blank"><font color="red"><u>Print</u></font></a></b></font>
</td>
</tr>
...
alert('<?php  echo $err;?>');
document.location="ord_billing.php";
</script>
<?php 
}
?>
