...
function show1()
{
	...
	$('#data8').load('credit_note_reports.php?cid='+cid+'&salper='+salper+'&brncd='+brncd+'&fdt='+fdt+'&tdt='+tdt+'&stat='+stat+'&ledg='+ledg+'&als='+als+'&blno='+blno).fadeIn('fast');
}
...
function exprt()
{
	...
	var blno=encodeURIComponent(document.getElementById('blno').value);
	var ledg=document.getElementById('ledg').value;
	document.location='credit_note_reports.php?cid='+cid+'&salper='+salper+'&brncd='+brncd+'&fdt='+fdt+'&tdt='+tdt+'&stat='+stat+'&ledg='+ledg+'&als='+als+'&blno='+blno;
}

function cncl(sl)
{
	$('#data8').load('cncl_credit_note.php?sl='+sl).fadeIn('fast');
}
 ...
 <body>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1 align="center">Credit Note Report</h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li class="active">Credit Note Report</li>
                    </ol>
                </section>
