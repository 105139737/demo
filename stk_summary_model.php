...
$('#sgh').load('stk_summarys_model.php?brncd='+brncd+'&scat='+scat+'&cat='+cat+'&rt='+rt+'&fdt='+fdt+'&tdt='+tdt).fadeIn('fast');
}
 ...
 <body>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1 align="center">
                Stock Summary Model Wise
                      
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li class="active"> Stock Summary Model Wise</li>
                    </ol>
                </section>
