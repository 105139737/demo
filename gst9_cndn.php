...
function show1()
{
 ...
 $('#data8').load('gst9_cndns.php?fdt='+fdt+'&tdt='+tdt+'&note_typ='+note_typ).fadeIn('fast');
}
	function xls()
{
 var fdt= document.getElementById('fdt').value;
...
document.location='gst9_cndns.php?fdt='+fdt+'&tdt='+tdt+'&sl=1'+'&note_typ='+note_typ;
}
</script>
 ...
 <body>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1 align="center">
              GSTR-9 SUPPLIER CN DN 
                      
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li class="active"> GSTR-9 SUPPLIER CN DN   </li>
                    </ol>
                </section>
