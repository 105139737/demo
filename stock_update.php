...
$data1= mysqli_query($conn,"select * from  main_branch where bnm='$GODOWN_NAME'")or die(mysqli_error($conn));
...
if($unit=='bun'){$stock_in=$QTY*$bgvlu;$rate1=$rate/$bgvlu;$uval=$bgvlu;}	
 ...
 echo $query21 = "INSERT INTO ".$DBprefix."stock (pcd,bcd,dt,unit,opst,nrtn,eby,dtm,stat,ret,refno,usl,uval,betno,rate,stk_rate)
VALUES ('$pcd','$brncd','$dt','$unit','$stock_in','Opening','$user_currently_loged','$dttm','1','$Rate','Opening','$usl','$uval','$betno','$Rate','$Rate')";
