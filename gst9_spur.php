...
function show1()
{
 ...
 $('#data8').load('gst9_spurs.php?fdt='+fdt+'&tdt='+tdt).fadeIn('fast');
}
	function xls()
{
 var fdt= document.getElementById('fdt').value;
...
document.location='gst9_spurs.php?fdt='+fdt+'&tdt='+tdt+'&sl=1';
}
</script>
 ...
 <body>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1 align="center">
              GSTR-9 Service  Purchase 
                      
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li class="active"> GSTR-9 Service Purchase   </li>
                    </ol>
                </section>
