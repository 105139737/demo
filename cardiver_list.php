...
$sln++;   
 ...
 ?>
		   ...
		   <td  align="center" style="cursor:pointer" onclick="edit('<?php  echo $x;?>')" >
            ...
            <td align="center"><?php  echo $cno;?></td>
            <td align="center"><?php  echo $cdet;?></td>
			<td align="center"><?php  echo $dnm;?></td>
			<td align="center"><?php  echo $addr;?></td>
			<td align="center"><?php  echo $mob1;?></td>
			<td align="center"><?php  echo $mob2;?></td>
			<td align="center"><?php  echo $lno;?></td>
			<td align="center"><?php  echo $ltyp;?></td>
