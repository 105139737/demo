...
<script>
	...
	$('#sdtl').load('sales_person_target_reports.php?fdt='+fdt+'&tdt='+tdt+'&brand='+brand).fadeIn('fast');
	}
...
function new_report()
{
window.open('sales_person_target_report_brek.php', '_blank');	
}
</script>
...
<form method="post" action="sales_person_target_reports_xls.php" id="form1"  name="form1">
<center>
...
<td align="right" colspan="4" >
 ...
 <input type="button" value=" Target Breakup " onclick="new_report()" class="btn btn-success"/>
