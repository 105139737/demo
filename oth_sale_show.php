	...
	function show1()
{
 ...
 $('#data8').load('oth_sale_list.php?fdt='+fdt+'&tdt='+tdt+'&snm='+encodeURIComponent(snm)).fadeIn('fast');

}
function view(blno)
{

window.open('bill_new_oth.php?blno='+encodeURIComponent(blno), '_blank');
window.focus();
