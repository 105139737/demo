...
<?}?>
	...
	<td  align="center" ><b>CURRENT SALES PERSON</b></td>
	</tr>	
</thead>
<tbody>
<?
...
$current_sale_per="";
//$queryspl="select * from main_cust_asgn  WHERE sl>0  and FIND_IN_SET('$cid', cust)>0";
$queryspl="select main_sale_per.nm from main_cust_asgn INNER JOIN main_sale_per ON main_sale_per.spid=main_cust_asgn.spid  WHERE main_cust_asgn.sl>0  and FIND_IN_SET('$cid', main_cust_asgn.cust)>0 order by main_cust_asgn.sl desc limit 0,1";
$resultspl=mysqli_query($conn,$queryspl);
while($rw=mysqli_fetch_array($resultspl))
{
$current_sale_per=$rw['nm'];
}
//$current_sale_per=$queryspl;
...
<td  align="left" ><b><?=$current_sale_per;?></b></td>
</tr>
<?
$tot+=$T;
