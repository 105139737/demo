...
$query1 = "SELECT sum(tamm) as gttl,sum(cgst_am) as cgst,sum(sgst_am) as sgst,sum(igst_am) as igst FROM main_quo_details_edt where blno='$blno'";
...
$query211 = "update main_quo set cust_nm='$cust_nm',cont='$cont',adrs='$adrs',gstin='$gstin',fst='$fst',tst='$tst',gst='1',amm='$tamm',tamm='$bilamm',gstam='$tgst',roff='$roff',payam='$payam',dt='$dt',edt='$edt',dttm='$dttm',bcd='$bcd',eby='$user_currently_loged' where blno='$blno'";
$result211 = mysqli_query($conn,$query211)or die(mysqli_error($conn)); 
	
$dlt=mysqli_query($conn,"delete from main_quo_details  where blno='$blno'") or die(mysqli_error($conn));

$query100 = "SELECT * FROM main_quo_details_edt where blno='$blno' order by sl";
...
$query2 = "DELETE FROM main_quo_details_edt WHERE blno='$blno'";
...
<font size="5"> <b><a href="quo_list.php" ><u>Back</u></a></b></font>
</td>
<td  align="left">
...
alert("<?php  echo $err;?>");
document.location="quotation_edt.php";
</script>
<?php 
}
?>