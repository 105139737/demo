...
if($drcnt==0)
{
$sql=mysqli_query($conn,"update main_product set cat='$cat',scat='$scat',pnm='$pnm',smvlu='$sret',mdvlu='$mret',bgvlu='$bret',hsn='$hsn',mrp='$ret' where sl='$sl'") or die(mysqli_error($conn));	
