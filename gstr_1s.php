...
$file="GSTR_1_Report $fdt to $tdt.xls";
...
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0,4, 'UQC');
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(1,4, 'Export Type');
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2,4, 'Revers Charge/ rovisional  Assessment');
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3,4, 'Note Type');
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4,4, 'Type');
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5,4, 'Tax Rate');
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6,4, 'POS');
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7,4, 'Invoice Type');
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8,4, 'Reason For Issuing Note');
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9,4, 'Nature  of Document');
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10,4, 'UR Type');
$objPHPExcel->removeSheetByIndex(13);
