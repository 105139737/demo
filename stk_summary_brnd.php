...
$('#sgh').load('stk_summarys_brnd.php?brncd='+brncd+'&scat='+scat+'&cat='+cat+'&rt='+rt+'&fdt='+fdt+'&tdt='+tdt).fadeIn('fast');
}
...
window.open('stk_summarys_product_brnd.php?brncd='+brncd+'&cat='+scat+'&rt='+rt+'&fdt='+fdt+'&tdt='+tdt,'_blank');
}
</script>
 ...
 <body>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1 align="center">
                Stock Summary Brand Wise
                      
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li class="active"> Stock Summary Brand Wise</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <!-- Main row -->
                     ...
                     <!-- /.box (chat box) -->
                            ...
                            <!-- TO DO List -->
<form method="post" action="stk_summarys_brnd.php" id="form1" name="form1">
