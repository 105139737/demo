...
$tigst_am=0;
$tgst=0;
$data= mysqli_query($conn,"select * from  main_openingdtl where sl>0 and blno='$blno' $bqr $godown1")or die(mysqli_error($conn));
...
$query61="select * from main_stock where pcd='$pcd' and dt>'$dt'";
$result51=mysqli_query($conn,$query61);
