...
?>
	...
	<td align="center"><?php  echo date('d-m-Y',strtotime($dt));?></td>
	<td align="left"><?php  echo $spid2;?></td>
	...
	?>
	<a href="details.php?cust_sle=<?php echo $cust_sl;?>&dt=<?php echo $dt;?>"><?php echo $cnt2.")".$cnm."<br>";?></a>
	<?php 
	}
	...
	$cnme="<font color='$color'>".$row13e['nm']."</font>";
	 ...
	 ?><a href="details.php?cust_sle=<?php echo $cust_sle;?>&&dt=<?php echo $dt;?>"><?php echo $csle."<br>";?></a><?php 
	}
