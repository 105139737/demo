...
<tr bgcolor="000">
<td colspan="24"><font size="5" color="#fff">Service Sale Details</font></td>
</tr>		
			<tr bgcolor="#e8ecf6">
...
$hsn=$row['hsn'];
	...
	if($blno==$blno1)
	{
		...
		<td  align="center"  >
		<a href="#" onclick="srv_sal_edit('<?php  echo $blno;?>')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
		</td>
		<td  align="center" ><?php  echo $dt;?></td>
		<td  align="center" ><a href="bill_new_gst_ser.php?blno=<?php echo rawurlencode($blno);?>" target="_blank"><?php  echo $blno;?></a></td>
