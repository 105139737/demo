...
$sl=$_REQUEST['sl'];
$data=mysqli_query($conn,"select * from main_technician where sl='$sl'")or die(mysqli_error($conn));
...
return false;
 ...
 return true;	
  ...
  <body>          <!-- Right side column. Contains the navbar and content of the page -->
