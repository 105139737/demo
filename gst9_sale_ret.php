...
function show1()
{
 ...
 $('#data8').load('gst9_sale_rets.php?fdt='+fdt+'&tdt='+tdt).fadeIn('fast');
}
	function xls()
{
 var fdt= document.getElementById('fdt').value;
...
document.location='gst9_sale_rets.php?fdt='+fdt+'&tdt='+tdt+'&sl=1';
}
</script>
            ...
            <aside class="right-side">
              ...
              GSTR-9 Sale Return
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"> GSTR-9 Sale Return</li>
                    </ol>
                </section>
