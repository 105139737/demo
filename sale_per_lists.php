...
while($row=mysqli_fetch_array($data))
{
	...
	else
	{
	   if($actnum==1)
	   {
		   $stat="<input type=\"button\" title=\"Click Here To Activate\" class=\"btn btn-block btn-danger btn-xs\" value=\"Deactivate\" onclick=\"act('".$user_sl."','0')\" name=\"B2\">";
	   }
	   else
	   {
			$stat="<input type=\"button\" value=\"Active\" title=\"Click Here To Dectivate\" class=\"btn btn-block btn-success btn-xs\" onclick=\"act('".$user_sl."','1')\" name=\"B1\">";
	   }
	}
...
<td align="left"><?php  echo $spid;?></td>
...
if($user_current_level<0)
{
	...
	<a href="sale_per_edt.php?sl=<?php  echo $sll;?>"><i class="fa fa-pencil-square-o" title="Click to Update"></i></a>
	<br><?php  echo $stat;?>
	</td>
	<?php 
}
