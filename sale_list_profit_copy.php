...
if($xls=='1')
{
	$jobLink=CreateNewJob('jobs/sale_list_profit_copy.php',$user_currently_loged,'Profit on last price',$conn);
    ?>
...
$query4="Select * from main_product_prc where psl='$pcd' and  edt<='$ppdt' order by sl desc limit 1";
$result4 = mysqli_query($conn,$query4);
while ($R4 = mysqli_fetch_array ($result4))
{
$close_rt=round($R4['lprc'],2);
}
