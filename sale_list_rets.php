...
<tr bgcolor="000">
<td colspan="24"><font size="5" color="#fff">Sale Return Details</font></td>
</tr>		
			<tr bgcolor="#e8ecf6">
...
$data1= mysqli_query($conn,"select * from  main_billing_ret where sl>0".$todts.$snm1.$brncd1.$gst_no1.$tp11.$sale_per1.$invdt1." order by dt,sl")or die(mysqli_error($conn));
...
$total_am=0;
$disa_am=0;
$data= mysqli_query($conn,"select * from  main_billdtls_ret where sl>0 and blno='$blno'".$pr_nm1.$godown1.$cat1.$scat1)or die(mysqli_error($conn));
...
$pnm=$row['pnm'];
	...
	if($blno==$blno1)
	{
		...
		<td  align="center" ><a href="bill_new_gst_ret.php?blno=<?php  echo $blno;?>" target="_blank"><?php  echo $blno;?></a></td>
		<td  align="left" > <b><div id="div<?php echo $sl;?>"><input type="text" class="valchal" id="b<?php $sl;?>" value="<?php echo $invdt;?>" onchange="updt('<?php echo $sl;?>',this.value)"></div></b></td>
		<td  align="left" ><?php  echo $nm;?> <b><?php  echo $invnm;?></b></td>
