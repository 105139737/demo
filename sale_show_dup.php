...
$('#data8').load('sale_list_dup.php?fdt='+fdt+'&tdt='+tdt+'&snm='+encodeURIComponent(snm)+'&brncd='+brncd+'&prnm='+prnm+'&tp1='+tp1+'&gstin='+gstin+'&godown='+godown+'&stat='+stat+'&scat='+scat+'&cat='+cat+'&sale_per='+sale_per).fadeIn('fast');
}
function view(blno)
{

window.open('bill_new_gst_dup.php?blno='+encodeURIComponent(blno), '_blank');
window.focus();
}
...
{
$('#can88').load('cancel_sale_invc_dup.php?billno='+encodeURIComponent(billno)).fadeIn('fast');
}
